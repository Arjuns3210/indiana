                    ...
                    <div class="card-content">
                        <div class="card-header">
                            <div class="row">
                                <div class="col-12 col-sm-7">
                                    <h5 class="pt-2">
                                                Verification For Estimator Head: #{{ $mipo->po_no .' / '. $mipo->region->region_name ?? '' }} /  {{ $mipo->revision_no ?? ''}}
                               </h5>
                                </div>
                        ...
                        <div class="card-body">
                                ...
                                <div class="tab-content">       
                                    ...
                                    <div class="tab-pane fade mt-2" id="team_details" role="tabpanel"
                                         aria-labelledby="team_details-tab">

                                        {{--  case incharge table--}}
                                        <div class="row my-3">
                                            <div class="col-12">
                                                <h5 class="mb-2 text-bold-500"><i class="ft-info mr-2"></i>
                                                    Case Incharge {{$mipo->caseIncharge->nick_name}} Details</h5>
                                    ...
                                    <div class="tab-pane fade mt-2" id="estimator_head_verification_details" role="tabpanel" aria-labelledby="estimator_head_verification_details-tab">
                                        <form id="addHeadVerificationForm" method="post" action="save_estimator_head_verification">
                                            @csrf
                                            <input type="hidden" name="mipo_id" id="mipoId" value="{{ $mipo->id ?? '' }}">
                                            <input type="hidden" name="head_approval_status" value="">
                                            <input type="hidden" name="head_reject_status" value="">
                                            <div class="row">
                                                <div class="col-sm-6">
                                                    <label>Estimator Head Remarks</label>
                                                    <textarea class="form-control" id="head_engg_remarks" name="head_engg_remarks" rows="4" {{$mipo->head_engg_approval_status != "pending" ? "readonly" : ''}}>{{$mipo->head_engg_remarks ?? ''}}</textarea><br/>
                                                </div>
                                            </div>
                                            <div class="row mt-3 mb-2">
                                                <div class="col-sm-12">
                                                    <div class="pull-right">
                                                        @if($mipo->head_engg_approval_status == "pending")
                                                        <button type="button" class="btn btn-success font-weight-bolder accept-btn mr-4 head_approval_status">Approve & forward</button>
                                                        <button type="button" class="reject-btn btn btn-danger py-1 mr-4 font-weight-bolder head_reject_status">Reject</button> 
                                                        @endif
                                                        <a href="{{URL::previous()}}" style="background: none !important;color: #F55252 !important" class=
                                                        "btn btn-outline-danger  py-1 font-weight-bolder cancel-btn">Cancel</a>
                                                    </div>
...
<script>
    ...
    $('.head_approval_status').click(function () {

        $("input[name='head_approval_status']").val('approve');
        $("input[name='head_reject_status']").val('');

        submitForm('addHeadVerificationForm','post')

    });

    $('.head_reject_status').click(function () {

        $("input[name='head_reject_status']").val('rejected');
        $("input[name='head_approval_status']").val('');
