                        ...
                        <div class="card-body">
                            ...
                            <div class="tab-content">
                                ...
                                <div class="tab-pane fade mt-2" id="case_incharge_details" role="tabpanel" aria-labelledby="case_incharge_details-tab">
                                    <form id="caseInchargeMipoForm" method="post" action="store-case-incharge-mipo-details">
                                        @csrf
                                        <div class="row">
                                            <div class="col-md-4 col-lg-4 col-md-4 border-right text-center">
                                                <p class="font-weight-bold">Upload DCL Document</p>
                                                <div class="shadow bg-white rounded d-inline-block">
                                                    <div class="input-file">
                                                        <label class="label-input-file">
                                                            Choose Files &nbsp;&nbsp;&nbsp;<i
                                                                    class="ft-upload font-medium-1"></i>
                                                            <input type="file" multiple name="caseInchargeDclDocument[]"
                                                                   class="dcl-document"
                                                                   id="caseInchargeDclDocument">
                                                        </label>
                                                    </div>
                                                </div>
                                                <p id="files-area">
	<span id="dclFilesList">
		<span id="dcl-files-names"></span>
	</span>
                                                </p>
                                                <div class="mt-2">
                                            ...
                                            <div class="col-md-4 col-lg-4 col-md-4 border-right text-center">
                                                <p class="font-weight-bold">Upload MI Document</p>
                                                <div class="shadow bg-white rounded d-inline-block">
                                                    <div class="input-file">
                                                        <label class="label-input-file">
                                                            Choose Files &nbsp;&nbsp;&nbsp;<i
                                                                    class="ft-upload font-medium-1"></i>
                                                            <input type="file" multiple name="caseInchargeMiDocument[]"
                                                                   class="mi-document"
                                                                   id="caseInchargeMiDocument">
                                                        </label>
                                                    </div>
                                                </div>
                                                <p id="files-area">
	<span id="miFilesList">
		<span id="mi-files-names"></span>
	</span>
                                                </p>
                                                <div class="mt-2">
                                                    @if(count($miDocumentsSrcArr))
                                                        @foreach($miDocumentsSrcArr as $key => $url)
                                                            ...
                                                            <div class="d-flex mb-1 mi-document-div-{{$uniqueKey}}">
                                                                ...
                                                                @if($mipo->ci_approval_status == "pending")
                                                                <a href="javascript:void(0)"
                                                                   class="btn btn-danger delete-mi-document  px-2" data-url="{{$url}}"  data-id="{{ $uniqueKey }}"><i class="fa ft-trash"></i></a>
                                                                    @endif
                                                            </div>
                                                        @endforeach
                                                    @endif
                                                    ...
                                                    <div class="input-file">
                                                        <label class="label-input-file">
                                                            ...
                                                            <input type="file" multiple
                                                                   name="caseInchargeExtraDocument[]"
                                                                   class="ci-extra-document"
                                                                   id="caseInchargeExtraDocument">
                                                        </label>
                                                    </div>
                                                    <input type="hidden" id="mipoId" name="mipo_id"
                                                           value="{{ $mipo->id ?? '' }}">
                                                    <input type="hidden" name="ci_approval_status" value="">
		...
		<span id="extra-files-names"></span>
                                                ...
                                                @foreach($extraCiDocumentsSrcArr as $key => $url)
                                                    @php
                                                        $uniqueKey = ++$key;
                                                    @endphp
                                                    <div class="d-flex mb-1 ci-extra-document-div-{{$uniqueKey}}">
                                                        <input type="text"
                                                        ...
                                                        @if($mipo->ci_approval_status == "pending")
                                                        <a href="javascript:void(0)"
                                                           class="btn btn-danger delete-ci-extra-document  px-2"
                                                           data-url="{{$url}}" data-id="{{ $uniqueKey }}"><i
                                            ...
                                            <div class="col-12 mt-2">
                                                <label>Remarks</label>
                                                <textarea class="form-control" id="ci_remarks" name="ci_remarks"
                                                          rows="4">{{$mipo->ci_remarks ?? ''}}</textarea><br/>
                                            </div>
                                            <div class="col-sm-6">
                                                <label>First Engineering Input Date</label>
                                                <input type="date" id="first_engg_input_date"
                                                       name="first_engg_input_date" class="form-control"
                                                       value="{{ $mipo->first_engg_input_date ?? '' }}">
                                                <br>
                                            </div>
                                            <div class="col-sm-6">
                                                <label>Last Engineering Input Date</label>
                                                <input type="date" id="last_engg_input_date" name="last_engg_input_date"
                                                       class="form-control"
                                                       value="{{ $mipo->last_engg_input_date ?? '' }}">
                                                <br>
                                            </div>
                                            <div class="col-sm-6">
                                                <label>Number of Days for Approval</label>
                                                <input type="number" id="no_of_days_for_approval"
                                                       name="no_of_days_for_approval" class="form-control"
                                                       value="{{ $mipo->no_of_days_for_approval ?? '' }}"
                                                       placeholder="Enter Number Of Days For Approval">
                                                <br>
                                            </div>
                                            <div class="col-sm-6">
                                                <label class="d-block">Currently availability of inputs</label>
                                                <textarea type="text" class="form-control"
                                                          name="input_availability" {{ ($mipo->input_availability_updated_by == 9 /*for design engineer*/) ? 'disabled' : '' }}>{{ $mipo->input_availability ?? '' }}</textarea>
                                            </div>
                                        </div>
                                        <div class="row mt-5">
                                            <div class="col-sm-12">
                                                <div class="pull-right">
                                                    @if($mipo->ci_approval_status == "pending")
                                                        <button type="button"
                                                                class="btn btn-primary  font-weight-bolder accept-btn mr-4 ci_upload_btn">
                                                            Upload Docs
                                                        </button>
                                                        <button type="button"
                                                                class="btn btn-success   font-weight-bolder accept-btn mr-4 ci_approval_status">
                                                            Approve & forward
                                                        </button>
                                                        <button type="button"
                                                                class="reject-btn btn btn-danger  py-1 mr-4 font-weight-bolder">
                                                            Reject
                                                        </button>
                                                        <a href="{{URL::previous()}}"
                                                           style="background: none !important;color: #F55252 !important"
                                                           class=
                                            "btn btn-outline-danger  py-1 font-weight-bolder cancel-btn">Cancel</a>
                                            @endif
                                        </div>
                                    ...
                                    @if(!empty($mipo->ci_remarks))
                                        <div class="d-flex justify-content-between p-3">
                                            <strong>Your Remarks</strong>
                                            <span class="ml-3">{{$mipo->ci_remarks}}</span>
                                        </div>
                                    @endif
                                    <div class="d-flex justify-content-between p-3">
...
<script>
    ...
    $('.delete-dcl-document').click(function(){
        let data = {
            url : $(this).attr('data-url'),
            path : 'caseincharge'
        }
        let uniqueId = $(this).attr('data-id');
        deleteDocuments (data,uniqueId,'.dcl-document-div-')
    });
    $('.delete-mi-document').click(function(){
        let data = {
            url : $(this).attr('data-url'),
            path : 'caseincharge'
        }
        let uniqueId = $(this).attr('data-id');
        deleteDocuments (data,uniqueId,'.mi-document-div-')
    });
    $('.delete-ci-extra-document').click(function(){
        let data = {
            url : $(this).attr('data-url'),
            path : 'caseincharge'
        }
        let uniqueId = $(this).attr('data-id');
        deleteDocuments (data,uniqueId,'.ci-extra-document-div-')
    });
    ...
    $('.dcl-document').change(function () {
        $('.dcl-file-count').text('Number of files uploaded: ' + this.files.length);
    });
    $('.mi-document').change(function () {
        $('.mi-file-count').text('Number of files uploaded: ' + this.files.length);
    });
    $('.ci-extra-document').change(function () {
        $('.ci-extra-file-count').text('Number of files uploaded: ' + this.files.length);
    });
    
    $('.ci_approval_status').click(function () {

        $("input[name='ci_approval_status']").val('approve');

        submitForm('caseInchargeMipoForm','post')

    });

    $('.reject-btn').click(function() {
        
        $("input[name='ci_approval_status']").val('rejected');

        submitForm('caseInchargeMipoForm', 'post');
    });

    $('.ci_upload_btn').click(function () {

        $('input[name=\'ci_approval_status\']').val('');

        submitForm('caseInchargeMipoForm', 'post');

    });

    const dclData = new DataTransfer();

    function handleDCLAttachmentChange () {
        const attachmentInput = document.getElementById('caseInchargeDclDocument');
        ...
        attachmentInput.addEventListener('change', function (e) {
            for (let i = 0; i < this.files.length; i++) {
                ...
                fileBloc.append('<span class=" file-delete dcl-file-delete"><span>+</span></span>').append(fileName);

                $('#dclFilesList > #dcl-files-names').append(fileBloc);
                dclData.items.add(file);
            }

            this.files = dclData.files;

            $('span.dcl-file-delete').click(function () {
                const name = $(this).next('span.name').text();
                $(this).parent().remove();

                for (let i = 0; i < dclData.items.length; i++) {
                    if (name === dclData.items[i].getAsFile().name) {
                        dclData.items.remove(i);
                        break;
                    }
                }

                document.getElementById('caseInchargeDclDocument').files = dclData.files;
            });
        });
    }

    handleDCLAttachmentChange();

    const miData = new DataTransfer();

    function handleMIAttachmentChange () {
        const attachmentInput = document.getElementById('caseInchargeMiDocument');
        ...
        attachmentInput.addEventListener('change', function (e) {
            for (let i = 0; i < this.files.length; i++) {
                ...
                fileBloc.append('<span class=" file-delete mi-file-delete"><span>+</span></span>').append(fileName);

                $('#miFilesList > #mi-files-names').append(fileBloc);
                miData.items.add(file);
            }

            this.files = miData.files;

            $('span.mi-file-delete').click(function () {
                const name = $(this).next('span.name').text();
                $(this).parent().remove();

                for (let i = 0; i < miData.items.length; i++) {
                    if (name === miData.items[i].getAsFile().name) {
                        miData.items.remove(i);
                        break;
                    }
                }

                document.getElementById('caseInchargeMiDocument').files = miData.files;
            });
        });
    }

    handleMIAttachmentChange();

    const extraData = new DataTransfer();

    function handleExtraAttachmentChange () {
        const attachmentInput = document.getElementById('caseInchargeExtraDocument');
        ...
        attachmentInput.addEventListener('change', function (e) {
            ...
            $('span.extra-file-delete').click(function () {
                ...
                document.getElementById('caseInchargeExtraDocument').files = extraData.files;
            });
        });
    }
