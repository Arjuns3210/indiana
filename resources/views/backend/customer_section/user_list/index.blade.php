                                ...
                                <div class="card-content">
                                    ...
                                    <div class="card-body">
                                        <div class="row mb-2" id="listing-filter-data" style="display: none;">
                                            ...
                                            <div class="col-md-4">
                                                <label> Phone</label>
                                                <input class="form-control mb-3" id="search_phone" name="search_phone" onkeypress='return event.charCode >= 48 && event.charCode <= 57 || event.charCode ==46'>
                                            </div>
                                            <div class="col-md-4">
                                                <label> Email</label>
                                            ...
                                            <table class="table table-bordered table-striped datatable" id="dataTable" width="100%" cellspacing="0" data-url="user_list_data">
                                                <thead>
                                                    <tr>
                                                        ...
                                                        @if($data['user_status'] || $data['user_edit'] || $data['user_view'])
