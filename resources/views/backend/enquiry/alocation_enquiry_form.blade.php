                             ...
                             <form id="addEnquiryDetailsForm" method="post" action="saveEnquiryDetails">
                                ...
                                <div class="tab-content">
                                    <div class="tab-pane fade mt-2 show active" id="enquiry_details" role="tabpanel" aria-labelledby="enquiry_details-tab">
                                        <div class="row">
                                            ...
                                            <div class="col-sm-6">
                                                ...
                                                <input class="form-control" type="hidden" id="revision_no" onkeypress="return event.charCode >= 48 && event.charCode <= 57" name="revision_no" value= @if(isset($revision)) {{$revision ? $revision : $enq_details->revision_no ?? 0 ;}} @else {{$enq_details->revision_no ?? 0 ;}} @endif  readonly><br/>
                                    ...
                                    <div class="tab-pane fade mt-2" id="allocation_details" role="tabpanel" aria-labelledby="allocation_details-tab">
                                        @if(isset($enq_details->category_id) && ($enq_details->category_id == '7' || $enq_details->category_id == '8' || $enq_details->category_id == '9'))
