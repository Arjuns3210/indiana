                                            ...
                                            <div class="table-responsive">
                                                <table class="table table-striped table-bordered">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>{{ $enquiries->category_mapped_date ? date('d-m-Y', strtotime($enquiries->category_mapped_date)) : '-'; }}  {{ $enquiries->category_mapped_time ?? '-';}}</td>
                                                    </tr>
                                                    <tr>
                                            ...
                                            <div class="table-responsive">
                                                <table class="table table-striped table-bordered">
                                                    <tr>
                                                        ...
                                                        <td>{{ $enquiries->allocation_date ? date('d-m-Y', strtotime($enquiries->allocation_date)) : '-'; }}  {{ $enquiries->allocation_time ?? '-';}}</td>
                                                    </tr>
                                                    <tr>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>{{ $enquiries->engg_transfer_date ? date('d-m-Y', strtotime($enquiries->engg_transfer_date)) : '-'; }}  {{ $enquiries->engg_transfer_time ? $enquiries->engg_transfer_time: '-'; }}</td>
                                                    </tr>
                                                    <tr>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>{{ $enquiries->typist_transfer_date ? date('d-m-Y', strtotime($enquiries->typist_transfer_date)) : '-'; }}  {{ $enquiries->typist_transfer_time ? $enquiries->typist_transfer_time : '-'; }}</td>
                                                    </tr>
                                                    <tr>
                                            ...
                                            <div class="table-responsive">
                                                <table class="table table-striped table-bordered">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>{{ $enquiries->estimated_date ? date('d-m-Y', strtotime($enquiries->estimated_date)) : '-'; }}  {{ $enquiries->estimated_time ?? '-';}}</td>
                                                    </tr>
                                                    <tr>
                                                        <td><strong>Engineer Remark</strong></td>
                                                        <td><?php
                                                        echo $enquiries->engineer_remark; ?>
                                                        </td>
                                                    </tr>
                                                </table>
                                            </div>
                                            ...
                                            <div class="table-responsive">
                                                <table class="table table-striped table-bordered">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>{{ $enquiries->typist_completed_date ? date('d-m-Y', strtotime($enquiries->typist_completed_date)) : '-'; }}  {{ $enquiries->typist_completed_time ?? '-';}}</td>
                                                    </tr>
                                                    <tr>
