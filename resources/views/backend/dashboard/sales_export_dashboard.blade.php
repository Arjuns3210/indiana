        ...
        <div class="main-content">
            ...
            <div class="content-wrapper">
                <section id="minimal-statistics">
                    <div class="row">
                        <div class="col-12">
                            <h1 class="content-header">Welcome to Indiana Sales Panel</h1>
                            ...
                            <div class="card">
                                <div class="card-content" style="height:150px;">
                                    <div class="card-body">
                                        <div class="media">
                                            <div class="media-body text-left">
                                                <h3 class="mb-1 warning">{{ $enquiry_added_today }}</h3>
...
$(document).ready(function () {
    ...
    categoryStatusForSale(sales_id);
    engineerStatusForSale(sales_id);
});
</script>
@endsection
