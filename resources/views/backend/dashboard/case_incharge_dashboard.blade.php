        ...
        <div class="main-content">
            ...
            <div class="content-wrapper">
                <section id="minimal-statistics">
                    <div class="row">
                        <div class="col-12">
                            <h1 class="content-header">Welcome to Indiana Case Incharge Panel</h1>
                                    ...
                                    <div class="card-body">
                                        <div class="media">
                                            <div class="media-body text-left">
                                                ...
                                                <span>Mapped Enquiries</span><br><br><br>
                                            </div>
                            ...
                            <div class="card">
                                <div class="card-content" style="height:150px;">
                                    <div class="card-body">
                                        <div class="media">
                                            <div class="media-body text-left">
                                                <h3 class="mb-1 primary">{{$enquiries_without_category}}</h3>
                                                <span>Enquries Without Category</span><br><br>
                                            </div>
                                            <div class="media-right align-self-center">
                                                <i class="ft-briefcase primary font-large-2 float-right"></i>
                                            </div>
