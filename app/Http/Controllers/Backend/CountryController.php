...
class CountryController extends Controller
{
    ...
    {
        return redirect('/webadmin/dashboard');
        // if(!checkPermission('country_view')){
        //     return redirect('/webadmin/dashboard');
        // }
    ...
    {
        return redirect('/webadmin/dashboard');
        // if(!checkPermission('country_add')){
        //     return redirect('/webadmin/dashboard');
        // }
        // $data = Currency::all();
    ...
    {
        return redirect('/webadmin/dashboard');
        // if(!checkPermission('country_edit')){
        //     return redirect('/webadmin/dashboard');
        // }
        // $data['data'] = Country::find($id);
        // $data['currency'] = Currency::all();        
    ...
    {
        if (!checkPermission('country_status')) {
            return redirect('/webadmin/dashboard');
        }
        $msg_data = array();
